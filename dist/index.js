...
var fs = __nccwpck_require__(147),
  ...
  fileURLToPath = __nccwpck_require__(912),
  join = path.join,
...
var sep = (__nccwpck_require__(17).sep) || '/';
...
/* eslint-disable */
const bindings = __nccwpck_require__(384);
const uplink = require(__nccwpck_require__.ab + "build/Release/uplink.node");
const project_js_1 = __nccwpck_require__(535);
const errorhandle = __nccwpck_require__(575);
...
const uplink = require(__nccwpck_require__.ab + "build/Release/uplink.node");
//
const download_js_1 = __nccwpck_require__(654);
const errorhandle = __nccwpck_require__(575);
const upload_js_1 = __nccwpck_require__(281);
//
//
...
__webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = exports.Kn = __webpack_unused_export__ = exports.k9 = void 0;
/* eslint-disable */
const access_js_1 = __nccwpck_require__(376);
const bindings = __nccwpck_require__(384);
const uplink = require(__nccwpck_require__.ab + "build/Release/uplink.node"), defaultValue = 0;
const errorhandle = __nccwpck_require__(575);
__webpack_unused_export__ = errorhandle;
class ListBucketsOptions {
    constructor(cursor = "") {
        this.cursor = cursor;
    }
}
exports.Kn = ListBucketsOptions;
class Permission {
...
__webpack_unused_export__ = UploadOptions;
...
__webpack_unused_export__ = DownloadOptions;
...
__webpack_unused_export__ = ListObjectsOptions;
class SharePrefix {
...
__webpack_unused_export__ = SharePrefix;
...
__webpack_unused_export__ = CustomMetadataEntry;
...
__webpack_unused_export__ = CustomMetadata;
class Config {
...
var dist_uplink = __nccwpck_require__(253);
;// CONCATENATED MODULE: ./packages/action/src/app/action.ts


// const debug = (content: any) => {
//   console.log('>> DEBUG:: ', content);
// };
const upload = ({ project }) => __awaiter(void 0, void 0, void 0, function* () { });
const download = ({ project }) => __awaiter(void 0, void 0, void 0, function* () { });
const listBuckets = ({ project, action }) => __awaiter(void 0, void 0, void 0, function* () {
    const bucket_list = yield project.listBuckets(new dist_uplink/* ListBucketsOptions */.Kn());
    // debug(bucket_list);
    action.setOutput('output', bucket_list);
});
const listFiles = ({ project }) => __awaiter(void 0, void 0, void 0, function* () { });
...
const callFunction = (inputs, action) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const uplink = new dist_uplink/* Uplink */.k9();
    const access = yield uplink.requestAccessWithPassphrase(inputs.satellite_url.value, inputs.api_key.value, inputs.passphrase.value);
    const project = yield access.openProject();
    yield exported_functions[function_type.toLowerCase()]({
        project,
        inputs,
        action,
    });
...
;// CONCATENATED MODULE: ./packages/action/src/app/index.ts



;// CONCATENATED MODULE: ./packages/action/src/main.ts
